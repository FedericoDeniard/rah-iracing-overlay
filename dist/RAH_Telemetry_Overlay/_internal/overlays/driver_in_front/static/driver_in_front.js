document.addEventListener("DOMContentLoaded", function() {
    ...
    function updateDriverData(data) {
        ...
        // Update lap time display based on session type
        if (isRaceSession) {
        ...
        // Update target pace based on session type
    ...
    function updateSessionDisplay() {
        // Update labels
        if (isRaceSession) {
            lapTimeLabelElement.textContent = "Last Lap:";
            targetPaceLabelElement.textContent = "Target Pace:";
        } else {
            lapTimeLabelElement.textContent = "Best Lap:";
            targetPaceLabelElement.textContent = "Delta Gap:";
        }
